...
print 'This is a GUI application that has been built using Python 2.7 and Tkinter 8.5'

print 'Please go to the main window titled \'STOPWATCH\' for using the application'
